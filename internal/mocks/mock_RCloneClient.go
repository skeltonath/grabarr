...
// Copy provides a mock function with given fields: ctx, srcFs, dstFs, filter, config
func (_m *MockRCloneClient) Copy(ctx context.Context, srcFs string, dstFs string, filter map[string]interface{}, config map[string]interface{}) (*models.RCloneCopyResponse, error) {
	ret := _m.Called(ctx, srcFs, dstFs, filter, config)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, map[string]interface{}, map[string]interface{}) (*models.RCloneCopyResponse, error)); ok {
		return rf(ctx, srcFs, dstFs, filter, config)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, map[string]interface{}, map[string]interface{}) *models.RCloneCopyResponse); ok {
		r0 = rf(ctx, srcFs, dstFs, filter, config)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, map[string]interface{}, map[string]interface{}) error); ok {
		r1 = rf(ctx, srcFs, dstFs, filter, config)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockRCloneClient_Expecter) Copy(ctx interface{}, srcFs interface{}, dstFs interface{}, filter interface{}, config interface{}) *MockRCloneClient_Copy_Call {
	return &MockRCloneClient_Copy_Call{Call: _e.mock.On("Copy", ctx, srcFs, dstFs, filter, config)}
}

func (_c *MockRCloneClient_Copy_Call) Run(run func(ctx context.Context, srcFs string, dstFs string, filter map[string]interface{}, config map[string]interface{})) *MockRCloneClient_Copy_Call {
...
func (_c *MockRCloneClient_Copy_Call) RunAndReturn(run func(context.Context, string, string, map[string]interface{}, map[string]interface{}) (*models.RCloneCopyResponse, error)) *MockRCloneClient_Copy_Call {
	_c.Call.Return(run)
	return _c
}
