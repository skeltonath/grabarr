...
// StartSync provides a mock function with given fields: ctx, remotePath, downloadConfig
func (_m *MockSyncService) StartSync(ctx context.Context, remotePath string, downloadConfig *models.DownloadConfig) (*models.SyncJob, error) {
	ret := _m.Called(ctx, remotePath, downloadConfig)
	...
	var r0 *models.SyncJob
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *models.DownloadConfig) (*models.SyncJob, error)); ok {
		return rf(ctx, remotePath, downloadConfig)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *models.DownloadConfig) *models.SyncJob); ok {
		r0 = rf(ctx, remotePath, downloadConfig)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.SyncJob)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, *models.DownloadConfig) error); ok {
		r1 = rf(ctx, remotePath, downloadConfig)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockSyncService_Expecter) StartSync(ctx interface{}, remotePath interface{}, downloadConfig interface{}) *MockSyncService_StartSync_Call {
	return &MockSyncService_StartSync_Call{Call: _e.mock.On("StartSync", ctx, remotePath, downloadConfig)}
}

func (_c *MockSyncService_StartSync_Call) Run(run func(ctx context.Context, remotePath string, downloadConfig *models.DownloadConfig)) *MockSyncService_StartSync_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*models.DownloadConfig))
	})
	return _c
}
...
func (_c *MockSyncService_StartSync_Call) RunAndReturn(run func(context.Context, string, *models.DownloadConfig) (*models.SyncJob, error)) *MockSyncService_StartSync_Call {
	_c.Call.Return(run)
	return _c
}
